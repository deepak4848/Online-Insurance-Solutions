<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage2.master" AutoEventWireup="true" CodeFile="ManageAgent.aspx.cs" Inherits="Admin_ManageOffice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="plcyheading" style="height:100px">
        ...
        <h6>We would appreciate if you could kindly take a moment to manage your agents visited.</h6>
        <label></label>
        <label id="lbl"></label>
...
<div id="admin" align="center">
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
        ...
        AllowPaging="True" PageSize="5" OnPageIndexChanging="GridView1_PageIndexChanging" DataKeyNames="AgentId" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowEditing="GridView1_RowEditing"
...
<ControlStyle CssClass="btnbuy"></ControlStyle>
            ...
            <asp:BoundField DataField="MobilNo" HeaderText="Mobile No" />
