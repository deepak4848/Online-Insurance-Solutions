<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage2.master" AutoEventWireup="true" CodeFile="changepassword.aspx.cs" Inherits="changepassword" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="chngpsd" style="height:500px">
        <div id="left" style="height: 450px; width: 900px; float: left; left: 230px; top: 20px; border:6px solid white; box-shadow:2px 1px 10px 1px #b3b9b9; padding-left:20px">
            ...
            <asp:Panel ID="Panel1" runat="server" Visible="true">
                <table style="top:15px">
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBox1" runat="server" CssClass="textform" placeholder="Enter Admin ID"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
            ...
            <asp:Panel ID="Panel2" runat="server" Visible="false">
                ...
                <table>
                    ...
                    <tr>
                        <td style="top:45px; font-family:Roboto; font-size:15px; color:#ff0000"><asp:Label ID="Label1" runat="server" Text="Label">Your Password successfully changed</asp:Label></td>
                    </tr>
                </table>
            </asp:Panel>
        ...
        <div id="right" style="height:450px; width:382px; float:right; right:184px; top:25px">
            <img src="../images/changpassword.jpg" />
        </div>
    </div>
</asp:Content>
