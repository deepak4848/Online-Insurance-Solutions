<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="AgentSearch1.aspx.cs" Inherits="AgentSearch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="agentsrchheading" style="height:100px; background-color:rgba(240, 244, 249, 0.43)">
        ...
        <h6>Our agent is ready to help you with all your insurance needs. Find yours today.</h6>
        <label></label>
        <label id="lbl"></label>
        </div>
    ...
    <div id="form" style="float:left; left: 150px; top:10px">
        ...
        <div id="form" style="float:left; left: 70px; top:10px">
            ...
            <table>
                ...
                <td id="icon"></td>
                <td id="text">ID</td>
                <td style="left:14px"><asp:TextBox ID="TextBox3" runat="server" CssClass="textform" placeholder="Search By Agent ID"></asp:TextBox></td>
            </tr>
        </table>

    </div>
        <div id="button" style="top:25px">
            <asp:Button ID="Button1" runat="server" Text="SEARCH NOW"  CssClass="searchbtn" OnClick="Button1_Click"/>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="gridview" PageSize="5" CellPadding="4" ForeColor="#333333" GridLines="None">
        ...
        <Columns>
            ...
            <asp:BoundField HeaderText="AGENT NAME" DataField="name" />
