...
public partial class CustomerRegistration : System.Web.UI.Page
{
    ...
    {
        TextBox6.Text = Convert.ToString(Session["policyno"]);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["dbcon"].ConnectionString);
        con.Open();
        string qry = "insert into Customer values(@t1,@t2,@t3,@t4,@t5,@t6,@t7,@t8,@t9,@t10,@t11,@t12,@t13)";
        SqlCommand cmd = new SqlCommand(qry, con);
        ...
        cmd.Parameters.AddWithValue("@t7", TextBox15.Text);
        cmd.Parameters.AddWithValue("@t8", DropDownList4.Text);
        cmd.Parameters.AddWithValue("@t9", DropDownList5.Text);
        cmd.Parameters.AddWithValue("@t10", TextBox10.Text);
        cmd.Parameters.AddWithValue("@t11", TextBox11.Text);
        cmd.Parameters.AddWithValue("@t12", TextBox13.Text);
        cmd.Parameters.AddWithValue("@t13", TextBox14.Text);
