<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="PaymentPage.aspx.cs" Inherits="PolicyformPage" %>
            ...
            <div id="btn" style="z-index:90">
                <table style="width:760px">
                    <tr>
                        ...
                        <td style="right:10px">
                            <asp:Button ID="Button2" runat="server" Text="CANCEL"  CssClass="btnbuy" OnClick="Button2_Click"/>
                        </td>
                    </tr>
                </table>
