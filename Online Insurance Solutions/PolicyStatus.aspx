<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="PolicyStatus.aspx.cs" Inherits="AgentSearch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="height:100px; top:5px; border-bottom:2px solid #b3b9b9; background-color:rgba(240, 244, 249, 0.43)">
         <div id="form1" style="float:left; left:320px; top:25px">
            <table>
                ...
                <td><asp:TextBox ID="TextBox3" runat="server" CssClass="textform2" placeholder="        Enter Your Policy No."></asp:TextBox></td>
            </tr>
        </table>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="gridview" PageSize="5" CellPadding="4" ForeColor="#333333" GridLines="None">
        ...
        <Columns>
            ...
            <asp:BoundField HeaderText="Policy name" DataField="policynm" />
            <asp:BoundField HeaderText="duration" DataField="duration" />
            <asp:BoundField HeaderText="start date" DataField="startdate" />
            <asp:BoundField HeaderText="Premium" DataField="premium" />
            <asp:BoundField HeaderText="Purchase date" DataField="purchdate" />
            <asp:BoundField HeaderText="Expiry date" DataField="expirydate" />
            <asp:BoundField DataField="assured" HeaderText="Assured" />
        </Columns>
