...
public partial class AgentSearch : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
            Label1.Visible = true;
            Label1.Text = "Please Enter Policy No";
        }
        else
        {
            SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["dbcon"].ConnectionString);
            conn.Open();
            string qryy = "select PolicyNo,policynm,duration,startdate,premium,purchdate,expirydate,assured from Policy where PolicyNo=@t1";
            ...
            {
                Label1.Visible = true;
                Label1.Text = "Your Policy Not found";
            }
        }
    }
}