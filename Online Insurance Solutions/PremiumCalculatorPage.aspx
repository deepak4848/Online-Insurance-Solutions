<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="PremiumCalculatorPage.aspx.cs" Inherits="PayPremiumPage" %>
    ...
    <div id="premcal" style="height:440px; background-image:url(images/bg_repeat.png)">
        <div id="left" style="height:380px; width:500px; border:5px solid white; float:left; left:230px; box-shadow: 1px 1px 5px rgba(127, 129, 129, 0.30); top:20px; background-color:white; padding-top:10px">
            ...
            <asp:DropDownList ID="DropDownList5" runat="server" CssClass="selectterm">
                ...
                <asp:ListItem Value="16">16 Year</asp:ListItem>
                <asp:ListItem Value="17">17 Year</asp:ListItem>
                <asp:ListItem Value="18">18 Year</asp:ListItem>
                <asp:ListItem Value="19">19 Year</asp:ListItem>
                <asp:ListItem Value="20">20 Year</asp:ListItem>
                <asp:ListItem Value="21">21 Year</asp:ListItem>
                <asp:ListItem Value="22">22 Year</asp:ListItem>
                <asp:ListItem Value="23">23 Year</asp:ListItem>
                <asp:ListItem Value="24">24 Year</asp:ListItem>
                <asp:ListItem Value="25">25 Year</asp:ListItem>
            </asp:DropDownList> 
            ...
            <asp:DropDownList ID="DropDownList6" runat="server" CssClass="selectterm">
                ...
                <asp:ListItem>12 Year</asp:ListItem>
                 ...
                 <table>
                <tr>
                    <td><asp:Button ID="Button3" runat="server" Text="SHOW PREMIUM" CssClass="premium" OnClick="Button3_Click"/></td>
                    <td><asp:Button ID="Button4" runat="server" Text="CANCEL" CssClass="premium" OnClick="Button4_Click"/></td>
                </tr>
            </table>
             </asp:Panel>
            ...
            <asp:DropDownList ID="DropDownList10" runat="server" CssClass="selectterm">
                ...
                <asp:ListItem>12 Year</asp:ListItem>
                 ...
                 <table>
                <tr>
                    <td><asp:Button ID="Button5" runat="server" Text="SHOW PREMIUM" CssClass="premium" OnClick="Button5_Click"/></td>
